...
model1.formula <- as.formula(paste("log(crmrte) ~",
                                   ...
                                   sep = " "))
model1 <- lm(model1.formula, data = crime[crime$exclude == 0,])
summary(model1)
```
...
model2.formula <- as.formula(paste("log(crmrte) ~ ",
                                   ...
                                   sep = ""))
model2 <- lm(model2.formula, data = crime[crime$exclude == 0,])
summary(model2)
```
...
model3.formula <- as.formula(paste("log(crmrte) ~ ",
                                   ...
                                   sep = ""))
model3 <- lm(model3.formula, data = crime[crime$exclude == 0,])
