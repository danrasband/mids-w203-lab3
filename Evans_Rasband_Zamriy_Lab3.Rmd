...
This second model remains consistent with our initial hypothesis, and actually improves the strength of both probability variables slightly. The overall predictive strength of the model has also increased. The adjusted $R^2$ for this model is 80.1, which is 12.9 points higher than our first model:
