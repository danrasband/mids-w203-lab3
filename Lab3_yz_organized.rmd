...
```{r}
ind_vars1 <- c("density", "prbarr_imp", "prbconv", "taxpc.ln", "pctymle", "pctmin80")
...
```{r}
ind_vars2 <- c("density", "west","prbarr_imp", "prbconv", "polpc.ln", "wfed.ln", "pctmin80",
               "west*polpc.ln")
...
```{r}
ind_vars_all <- c("prbarr_imp", "prbconv", "prbpris", "avgsen", "polpc.ln", "density", "taxpc.ln",
...
```{r}
par(mfrow=c(1,3))
plot(crmrte_lm0, which = 4)
plot(crmrte_lm2, which = 4)
plot(crmrte_lm_all, which = 4)
```
