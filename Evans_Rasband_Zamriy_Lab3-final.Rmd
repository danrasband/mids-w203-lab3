...
It appears that zero-conditional mean is closer to 0 on the lower end of the dependent variable. However, this assumption still seems to be violated. Including more variables as tested in model 3 did not improve this situation. Hence, it is likely that omitted variables are contributing to the violation. These are discussed below. 
