...
It is likely that omitted variables are contributing to the violation. These are discussed below. As there are more variables included in the model three, this has helped to account for the conditional errors
...
It is also worth mentioning that, due to the difference in the crime levels in the West of the state, there may be more specific policies that would apply there. More rural and sparcely populated communities where families have deeper roots and stronger ties may attract a different type of crime than the mix in the rest of the state
