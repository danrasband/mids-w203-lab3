...
```{r, echo = TRUE}
interpret1 <- c("","For an increase of 100 people per square mile in density,
...
interpret2 <- c(
  ...
  more factors. For each 100 persons per square mile increase in density,
