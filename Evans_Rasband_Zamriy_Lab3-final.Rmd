...
Despite adding a lot more variables, the $R^2$ of the all-inclusive regression model went up only to 83.0% (from 80.1% in model 2). That means that additional variables did not contribute much to the model fit.
